 ...
 */
public class UniformeDiscreta extends AbstractDistribution{
    ...
    public double getValue() {
        return Math.ceil(a+((b-a+1)* Generator.random()));	
    }
    ...
    public void checkParameters(Hashtable<String, Double> par) throws ParametersException {
        ...
        if( aTest<= 0)
            throw new ParametersException("El limite inferior debe ser mayor que cero");
