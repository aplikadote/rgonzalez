...
public class PlotFunctionPanel extends javax.swing.JPanel {
    ...
    public PlotFunctionPanel(double[][] data, String title, String xTitle, String yTitle, double min) {
        initComponents();
        this.data = data;
        initValues();
        ...
        updateScroll(min);
        this.sliderCross.setValue(toSlider(min));
    }

    public void initValues() {
        this.n = data.length;
        this.sliderMinimun = 0;
        this.sliderMaximun = n-1;
        this.sliderCross.setMinimum(sliderMinimun);
        this.sliderCross.setMaximum(n-1);
...
//        return (int) (sliderRealRate * realValue + sliderMinimun)-1;
...
private void sliderCrossStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderCrossStateChanged
    ...
    private void updateScroll(double realValue) {
        if (this.chart != null) {
            ...
            double yValue;
            try {
                yValue = data[toSlider(realValue)][1];
            } catch (Exception e) {
                yValue = n - 1;
