...
/**
 * Caso de prueba para Trio.
 * @author Administrador
 */
public class PokerTest05 {
...
//        Deck deck = Deck.getInstance();
        ...
        ocardList.add(new Card(PokerConstants.HEART, PokerConstants.EIGHT));
        ocardList.add(new Card(PokerConstants.DIAMOND, PokerConstants.EIGHT));
        ocardList.add(new Card(PokerConstants.CLUB, PokerConstants.EIGHT));
        ocardList.add(new Card(PokerConstants.SPADE, PokerConstants.FOUR));
        ocardList.add(new Card(PokerConstants.CLUB, PokerConstants.SIX));
